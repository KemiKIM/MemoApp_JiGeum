...
extension ImageResource {
    ...
    static let background4 = ImageResource(name: "background4", bundle: resourceBundle)

    /// The "custom-arrow-left" asset catalog image resource.
    static let customArrowLeft = ImageResource(name: "custom-arrow-left", bundle: resourceBundle)

    /// The "custom-arrow-right" asset catalog image resource.
    static let customArrowRight = ImageResource(name: "custom-arrow-right", bundle: resourceBundle)
